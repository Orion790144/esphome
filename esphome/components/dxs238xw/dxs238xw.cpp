...
  if (this->name##*sensor* != nullptr) { 
    if (this->name##*sensor*->get_raw_state() != (value) || this->get_component_state() == COMPONENT_STATE_SETUP) { 
      this->name##*sensor*->publish_state(value); 
    } 
  }
#else
#define UPDATE_SENSOR(name, value)
...
    } 
    if (this->name##*sensor*->get_raw_state() != value_float || this->get_component_state() == COMPONENT_STATE_SETUP) { 
      this->name##*sensor*->publish_state(value_float); 
    } 
  }
...
  if (this->name##*text_sensor* != nullptr) { 
    if (this->name##*text_sensor*->get_raw_state() != (value) || this->get_component_state() == COMPONENT_STATE_SETUP) { 
      this->name##*text_sensor*->publish_state(value); 
    } 
  }
#else
#define UPDATE_TEXT_SENSOR(name, value)
...
  if (this->name##*binary_sensor* != nullptr) { 
    if (this->name##*binary_sensor*->state != (value) || this->get_component_state() == COMPONENT_STATE_SETUP) { 
      this->name##*binary_sensor*->publish_state(value); 
    } 
  }
#else
#define UPDATE_BINARY_SENSOR(name, value)
...
  if (this->name##*number* != nullptr) { 
    if (this->name##*number*->state != (value) || this->get_component_state() == COMPONENT_STATE_SETUP) { 
      this->name##*number*->publish_state(value); 
    } 
  }
#else
#define UPDATE_NUMBER(name, value)
...
  if (this->name##*switch* != nullptr) { 
    if (this->name##*switch*->state != (value) || this->get_component_state() == COMPONENT_STATE_SETUP) { 
      this->name##*switch*->publish_state(value); 
    } 
  }
#else
#define UPDATE_SWITCH(name, value)
...
  this->preference_##name##_ = global_preferences->make_preference<uint32_t>(this->hash_##name##*); 
  if (this->name##*number* != nullptr) { 
    this->data##*.name = this->read_initial_number_value_(this->preference_##name##*, preference_string, default_value); 
  }
